...
export class DetailDialogComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<DetailDialogComponent>,private authService: AuthService,  private foodService: FoodService, @Inject(MAT_DIALOG_DATA) public data: any) {
    this.id = data.id;
  }
  id: string;
  loading = false;
