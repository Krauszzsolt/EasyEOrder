    ...
    public partial class EasyEOrderMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "e87a50b7-ce6b-4eb9-b99c-a7a4b01e79db", 0, "aa0fa1af-3431-4c64-b26a-378dfc42c2c2", "test@test.test", true, false, null, "TEST@TEST.TEST", "TEST@TEST.TEST", "AQAAAAEAACcQAAAAEDC/cxi1tiNwAcOKtbjgHurvhe6hMbztzMCUXqqW15YnI3Xc7HUP1zpVAB/3FI7uJQ==", null, false, null, null, null, "string", false, "test@test.test" });
